...
$.ajax = function(endPoint, options) {
  var hollaback = options.success;
  // if (typeof data === 'function') {
  //   hollaback = data;
  // }

  if (endPoint === "https://blockchain.info/rawaddr/1M3p9Gfhn9vrPgjYLZEcFSnxSM6WuCVm2Y-empty") {
    // Empty transactions
    var data = {
    ...
    hollaback(data);
  } else if (endPoint === "https://blockchain.info/rawaddr/1KCVyR5Ucq3ExNhVFwbTWkeviU1ZpWpSoH-2credit1debit") {
